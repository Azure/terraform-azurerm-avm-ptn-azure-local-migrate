...
variable "disks_to_include" {
  ...
  default = [
    {
      disk_id          = "6000C29f-7e33-32c7-73bc-5d4136822573"
      disk_size_gb     = 40
    ...
    {
      disk_id          = "6000C298-8efe-5d61-83c8-ae4adca7e5eb"
      disk_size_gb     = 10
      disk_file_format = "VHDX"
      is_os_disk       = false
      is_dynamic       = true
...
variable "machine_id" {
  type        = string
  default     = "/subscriptions/265ca7e5-909a-455d-9459-7c7041c1c37d/resourceGroups/saif-project-021826-rg/providers/Microsoft.OffAzure/VMwareSites/src28251site/machines/100-69-177-104-f1c605c7-d8ee-48df-a65a-9d3c1c60bc20_50236a85-980d-090a-3e67-71a2befa34fb"
...
variable "os_disk_id" {
  type        = string
  default     = "6000C29f-7e33-32c7-73bc-5d4136822573"
...
variable "target_vm_name" {
  type        = string
  default     = "test-vm2-ws2019efi-migrated"
